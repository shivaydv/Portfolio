...
const Heroimg = () => {
 ...
 <svg  className="w-[100%] h-[100%] " xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="80 -10 100.1879 500" height="650.68268" width="711.1879" data-name="Layer 1" id="b52d7e2d-d80f-4111-b6ed-d15502ee1edd">
  ...
  <g id="head">
    ...
    <g id="eyeb">
      <motion.g animate={{translateY:"10px"}} transition={{repeat:Infinity,repeatType:"reverse",duration:2}} id="g106">
        <path id="path104" d="M84.6,92c0,0,16.8-9.6,14.2-12.2C96.2,77.2,84.6,92,84.6,92z" fill="#000000"/>
      </motion.g>
      <motion.g animate={{translateY:"10px"}} transition={{repeat:Infinity,repeatType:"reverse",duration:2}} id="g110">
        <path id="path108" d="M151.5,91.5c0,0-16.8-9.6-14.2-12.2C139.9,76.8,151.5,91.5,151.5,91.5z" fill="#000000"/>
      </motion.g>
    </g>
    <motion.g animate={{translateX:"6px"}} transition={{repeat:Infinity,repeatType:"reverse",duration:2}} id="eyey2">
...
<g id="legs">
  <g id="g188">
    <path id="path186" d="M15.7,303.3c0,0-1.9-11.2,8-15c9.9-3.8,37,3.2,64.8,18.5c27.8,15.3,69.9-5.1,98-14.7          c28.1-9.6,45.9-10.1,49.3,0.9c0,0-24.7,39.3-45.5,40.6s-48.2-1-48.2-1l-31.9,0.6c0,0-24.3,8.6-28.7,8.3          C77,341.2,20.8,325.3,15.7,303.3z" fill="#212121"/>
  </g>
  <g id="g192">
    <path id="path190" d="M91.2,333.1c0,0,20.3-12,21.9-11.5c1.6,0.5,6.9,5.9,9.1,6.9c2.2,1,1.6,3.7,1.6,3.7l-3,9.3l-22.3-1.9          L91.2,333.1z" fill="#2B2B2B"/>
  </g>
  <g id="g196">
  ...
  <g id="notebook">
    <g id="g210">
      ...
      <g id="g208">
        <path id="path206" d="M212.5,289.7c0,3.8-3,6.8-6.8,6.8H37.3c-3.8,0-6.8-3-6.8-6.8V186.3c0-3.8,3-6.8,6.8-6.8h168.4              c3.8,0,6.8,3,6.8,6.8V289.7z" fill="#292A2D"/>
      </g>
    </g>
    <g id="logobook">
      <rect rx="3" id="rect1150" fill="#E3405F" width="15" height="15" x="-92.187965" y="245.78786" transform="rotate(-45)"/>
    </g>
  ...
  <g id="g222">
    <path id="path220" d="M135.7,326.9l-1,27.8c0,0,55.2-2.9,87.4-33.8s2.2-37,2.2-37s-10.2-0.6-10.2,1.3          C214.2,287,191.9,319.9,135.7,326.9z" fill="#000000"/>
  </g>
  <g id="g226">
  ...
  <g id="g230">
    <path id="path228" d="M130.9,361c0.9-0.2-1.6-23.3-1.6-23.3s-68.3-5.1-98.3-45.6h0c-1.5-2.9-6.7-5.8-9.3-3.9l-2.3,1          c-8.7,6.3-7.5,19.3-1.7,28.4c3.1,4.8,7.6,10.1,14.3,15.3C53.4,349.5,88.8,368.7,130.9,361z" fill="#000000"/>
  </g>
  ...
  <g id="pe">
    <g id="g242">
      <path id="path240" d="M150.9,347c-0.7-0.5,12.3-10.4,13.4-10.2c1.1,0.2,11.6,9.4,12.8,9.4c1.1,0,27.8,8.5,25.2,16.4l-25.5-0.6            l-19.9-1.1C156.8,360.9,155.3,350.7,150.9,347z" fill="#2B2B2B"/>
    </g>
    <g id="g246">
      <rect id="rect244" height="7.9" width="1.9" fill="#777070" transform="matrix(0.9869 0.1612 -0.1612 0.9869 59.7596 -21.5769)" y="353.5" x="161.9"/>
    </g>
    <g id="g250">
      <rect id="rect248" height="7.6" width="1.9" fill="#777070" transform="matrix(0.9821 0.1884 -0.1884 0.9821 70.3837 -24.9184)" y="353.9" x="165.3"/>
    </g>
    <g id="g254">
      <rect id="rect252" height="7" width="1.9" fill="#777070" transform="matrix(0.9989 4.593970e-002 -4.593970e-002 0.9989 16.6397 -7.4027)" y="354.8" x="168.4"/>
    </g>
    <g id="g258">
      <rect id="rect256" height="6.1" width="1.9" fill="#777070" transform="matrix(0.9914 0.1308 -0.1308 0.9914 48.3763 -19.4954)" y="355.6" x="171.7"/>
    </g>
  </g>
  <g id="g263">
