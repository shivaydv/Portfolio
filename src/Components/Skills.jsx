      ...
      <div className="flex flex-wrap  w-full max-md:justify-evenly justify-center gap-4 md:gap-10">
        {
          skills.map((item,i)=>{
            return (
              <motion.div key={item.name} variants={fadein} initial="initial" whileInView="animate" viewport={{once:true}} custom={i} className=" w-36 h-36 px-6 py-4  flex-col gap-2   text-center flex items-center rounded-lg justify-center  bg-white/10 shadow-2xl
              ">
